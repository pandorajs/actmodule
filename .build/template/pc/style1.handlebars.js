define("pandora/actmodule/1.0.0/template/pc/style1.handlebars", [ "gallery/handlebars/1.3.0/handlebars-runtime" ], function(require, exports, module) {
    ...
    module.exports = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program1(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '!a-3-240x.jpg" width="180" height="135" alt="" />\r\n	</div>\r\n	';
            return buffer;
        }
        ...
        function program7(depth0, data) {
            return '\r\n		<a href="#lottery" class="zq-actcompt-btn zq-actcompt-btn-begin" id="zq_actcompt_not_yet_start">即将开始</a>\r\n		<p class="zq-actcompt-state-tt"><span class="zq-actcompt-or"></span></p>\r\n		';
        }
        function program9(depth0, data) {
            var buffer = "", stack1, helper;
            buffer += '\r\n		<a href="#lottery" class="zq-actcompt-btn zq-actcompt-btn-in" id="zq_actcompt_in_progress">立即领取</a>\r\n		<p class="zq-actcompt-state-tt">已有<span class="zq-actcompt-or zq-actcompt-fb">';
        ...
        function program11(depth0, data) {
            var buffer = "", stack1, helper;
            buffer += '\r\n		<a href="#lottery" class="zq-actcompt-btn zq-actcompt-btn-end"  id="zq_actcompt_ended">已结束</a>\r\n		<p class="zq-actcompt-state-tt">已有<span class="zq-actcompt-or zq-actcompt-fb">';
            if (helper = helpers.joins) {
                stack1 = helper.call(depth0, {
                    hash: {},
                    data: data
        ...
        buffer += '<div class="zq-actcompt zq-actcompt1">\r\n	';
